...
public:
  ...
  /**
   * @brief Function to change the current Game's map definition.
   *
   * @param mapId  Map identifier.
   */
  void ChangeMap(mapData_t mapId);
...
private:
  ...
  /**
   * @brief Local function to clear all Tiles, Triggers and Objects from the
   *        current map.
   */
  void _ClearMapData();
};
