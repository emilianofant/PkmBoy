 ...
 *
 * @param tr  Trigger identifier from Resources.cpp definitions file.
 * @param sc  Scaling factor.
 */
  void CreateTrigger(triggerEnum_t tr, int sc);

  /**
   * @brief Create a Dialog Box (GUI) object
   *
   * @param sc  Scaling factor.
   */
  void CreateDialogBox(int sc);
